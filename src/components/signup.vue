    ...
    <div class="home">
        ...
        <div class="signup1">
            <form @submit.prevent="handlesubmit">
                ...
                <!-- <div class="signlink">
                <p>Already have an account? <router-link to="/signup">signup</router-link> here.</p>
            </div> -->
            </form>
        </div>
    </div>
...
export default {
    ...
    setup(props, context) {
        ...
        const handlesubmit = async () => {
            // console.log(displayName.value , email.value , password.value)           //print value to console
